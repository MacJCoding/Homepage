...
'<li class="tab, dropdown">'+
	...
	'</div>'+
'</li>'+
'<li class="tab"><a class="link" href="../fusara-duelists-devlogs.html">Devlogs</a></li>'+
'<li class="tab"><a class="link" href="../fusara-duelists-patch-notes.html">Patch Notes</a></li>'+
...
'<div class="sidebar-dropdown-btn">All&nbsp;Games</div>'+
...
'<a class = "sidebox" class="link" href="../fusara-duelists-patch-notes.html">Patch&nbsp;Notes</a>'+
'</div>'+
'<div class="sidebar-dropdown-btn">Sites</div><div class="sidebar-dropdown-container">'+
	...
	'<a class="sidebox" class="link" href="https://github.com/MacJCoding">GitHub</a></div>'
